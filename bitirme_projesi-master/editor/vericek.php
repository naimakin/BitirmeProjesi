...
?>
    <center><table width="200" border="1" cellpadding="0" align="center">
        ...
        <?php 
        $sayici=1;
        $vericek= mysql_query("select * from sorular order by dersadi,kadi ASC");
    ...
    <td>
        <a href="http://localhost/MVC/sorular/soruekleme/<?php echo $sid?>"> Düzenle || </a>
        <a href="http://localhost/MVC/sorular/sorusil/<?php echo $sid?>">  Sil  </a>
    </td>
        </tr>
        <?php 
        $sayici++;
