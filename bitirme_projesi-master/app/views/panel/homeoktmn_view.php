		<div id="main">
			<div class="half_w half_left">
                            <div class="h_title"  margin: 0 auto"><b>OMU MÜHENDİSLİK ARMA</b></div>
                                <div id="container" style="width: 200px; margin: 0 auto"></div>
					<img src="../public/omu/omuarma.jpg"/>
			</div>
			<div class="half_w half_right">
				<div class="h_title">Site statistics</div>
				<img src="../public/omu/arma.jpg"/>
			</div>
			
			<div class="clear"></div>
			
			<div class="full_w">
				<div class="h_title"><b>OMU MÜHENDİSLİK FAKULTESİ</b></div>
                                <img src="../public/omu/muhfak.jpg"/>
			</div>
