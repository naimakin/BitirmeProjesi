...
<div class="full_w">
    ...
    <form name="kanekle" action="<?php echo SITE_URL?>/panel/mailgonder" method="POST" onsubmit="return false;" id="form">
<!--    <form action="<?php echo SITE_URL?>/panel/modulEkleFonks" method="POST">-->
    <table>
        <div class="element">
                <label for="email">E MAİl(*gerekli)</label>
                <input type="text" name="email" id="email1"/>
        </div>
        <div class="element">
                <label for="konu">KONU ADI(*gerekli)</label>
                <input type="text" name="konu" id="konu1"/>
        </div>
        <div class="element">
                <label for="mesaj">MESAJINIZ(*gerekli)</label>
                <textarea name="mesaj" id="mesaj1" cols="40" rows="5"></textarea>
        </div>
        <div class="entry">
